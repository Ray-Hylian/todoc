...
import com.cleanupRB.todocByRB.R;
import com.cleanupRB.todocByRB.injection.Injection;
import com.cleanupRB.todocByRB.injection.ViewModelFactory;
...
public class MainActivity extends AppCompatActivity implements TasksAdapter.DeleteTaskListener {
    ...
    private TaskViewModel taskViewModel; //déclaration du viewmodel
    ...
    private void getProject(){
        this.taskViewModel.getProject().observe(this, this::updateProjects);
    }
